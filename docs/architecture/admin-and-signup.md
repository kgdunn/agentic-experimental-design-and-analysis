...
This document describes the **current** (post-`0008_admin_roles_and_setup_tokens` migration) design. It supersedes any notes about `ADMIN_EMAILS`, which is no longer consulted at runtime.
